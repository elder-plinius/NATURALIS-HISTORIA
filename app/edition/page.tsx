    ...
    <main className="editorial-page">
      <article className="editorial-leaf">
        ...
        <section className="editorial-panel" id="rights">
          ...
          <p>The <a href="/provenance.json">machine-readable provenance ledger</a> publishes hashes and derivative paths for all modern plates. All forty-seven plate masters and the social card have source-bound creator/tool provenance and AGPL-3.0 clearance records; the thirty-one legacy masters were reconciled on 26 August 2026. This establishes the media-rights state of the source package. It does not state that a public deployment exists or that publication has been authorized.</p>
        </section>
        ...
        <section className="editorial-prose" id="corrections">
          ...
          <p>Verified repairs enter the reviewable correction ledger rather than silently rewriting the sources. Release-candidate edition {policy.version}, dated 24 August 2026.</p>
        </section>
